...
<main>
    ...
    <div class="bg-cover">
        <div class="row">
            <div id="carouselExampleIndicators" class="carousel slide col-md-8 offset-md-2" data-ride="carousel"
                ...
                <div class="h-40 center-me">
                    <div class="my-auto">
                        <form class="form-signin" action="includes/login-helper.php" method="post"
                            ...
                            <input type="text" id="inputEmail" name="uname" class="form-control"
                            ...
                            <button class="btn btn-lg btn-secondary btn-block" name="login-submit" type="submit">Sign
                                In</button>
